...
class MySphere extends CGFobject {
    ...
    initBuffers() {
        ...
        const thetaInc = Math.PI / this.stacks;
        ...
        for (let sliceIter = 0; sliceIter <= this.slices; sliceIter++) {
            for (let stackIter = 0; stackIter <= this.stacks; stackIter++) {
                ...
                // Theta varies from [-90, 90] degrees
                // Phi varies from [0, 360] degrees
                const theta   = - Math.PI / 2 + stackIter * thetaInc;
                ...
                this.texCoords.push(sliceIter / this.slices, 1 - stackIter / this.stacks);
            }
        }
